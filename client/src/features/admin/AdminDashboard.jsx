...
import { formatCompactDate, formatCurrency, formatStatusLabel } from "../../utils/formatters.js";
import AdminChat from "./AdminChat.jsx";
import AdminSubscriptionsTab from "./AdminSubscriptionsTab.jsx";
import {
  Btn,
  CheckboxField,
  EmptyRow,
...
const TABS = [
  ...
  { id: "subscriptions", label: "Restaurant Plans" },
  { id: "menu", label: "Menu" },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        ...
        {tab === "subscriptions" ? <AdminSubscriptionsTab /> : null}
